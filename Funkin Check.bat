...
set functions63=onSpawnNote onKeyPressPre onKeyRealeasePre onKeyReleasePre onKeyPress onKeyRelease onGhostTap goodNoteHitPre opponentNoteHitPre preUpdateScore preUpdateScore onUpdateScore onEventPushed onSoundFinished
